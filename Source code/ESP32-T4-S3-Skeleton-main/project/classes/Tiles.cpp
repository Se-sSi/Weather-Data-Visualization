...
void Tiles::create_ui()
{
    ...
    // Tile #1
    {
        ...
        // Apply colors
        apply_bg_color(t1_, /*dark=*/false);
        apply_text_color(t1_title_label_, /*dark=*/false);
        apply_text_color(t1_ver_label_, /*dark=*/false);
        apply_text_color(t1_group_label_, /*dark=*/false);
    ...
    // Tile #2
    {
        ...
        apply_text_color(t2_label_, /*dark=*/false);
    }
}
...
void Tiles::on_tile_clicked(lv_event_t* e)
{
    ...
    self->apply_bg_color(self->t1_, self->dark);
    self->apply_bg_color(self->t2_, self->dark);
    self->apply_text_color(self->t1_title_label_, self->dark);
    self->apply_text_color(self->t1_ver_label_, self->dark);
    self->apply_text_color(self->t1_group_label_, self->dark);
    self->apply_text_color(self->t2_label_, self->dark);
