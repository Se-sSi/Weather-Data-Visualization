...
void TemplateTile::create_ui()
{
    ...
    // Tile #1
    {
        ...
        lv_label_set_text(t1_label_, "Example tile 1");
    ...
    // Tile #2
    {
        ...
        lv_label_set_text(t2_label_, "Example tile 2 (click for dark mode)");
        ...
        lv_obj_add_event_cb(t2_, &TemplateTile::on_tile2_clicked, LV_EVENT_CLICKED, this);
    }
}

void TemplateTile::apply_tile_colors(lv_obj_t* tile, lv_obj_t* label, bool dark)
{
    // Background
...
void TemplateTile::on_tile2_clicked(lv_event_t* e)
{
  auto* self = static_cast<TemplateTile*>(lv_event_get_user_data(e));
